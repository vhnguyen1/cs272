...
public class Controller
{
    ...
    public static Controller getInstance()
    {
        if (theOne == null)
        {
            ...
            try
            {
                ...
                ArrayList<ArrayList<String>> userResultList = theOne.mUserDB.getAllRecords();

                for (ArrayList<String> values : userResultList)
                {
                ...
                ArrayList<ArrayList<String>> gameResultList = theOne.mVideoGameDB.getAllRecords();
                theOne.initializeVideoGameDBFromFile();
                for (ArrayList<String> values : gameResultList)
                {
                    {
                        int id = Integer.parseInt(values.get(0));
                        String name = values.get(1);
    ...
    public ObservableList<VideoGame> getGamesForCurrentUser()
    {
        ...
        if (mCurrentUser != null)
        {
            try
            {
                ArrayList<ArrayList<String>> resultList = theOne.mUserGamesDB
